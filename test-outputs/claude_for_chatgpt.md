# Previous Conversation: Managing multiple R versions with rig

*Imported from claude.ai on 2026-01-31*
...
### Attached Document: getting_started.qmd
...
## Assistant (Message 2)
 ...
 Based on these thoughtful comments from R project maintainers, here's how I'd suggest adding a section about `rig`:
...
write this in quarto md format man, gimme the hashes and the ticks
...
*[Image attachment: 1766175090429_image.png]*

---

## Assistant (Message 6)

 This looks great! The formatting is rendering nicely. A few observations:
...
what should be the commit msg

---

## Assistant (Message 8)

 Here's a suggested commit message following conventional commit style:
...
from the first option description, remove the feedback part and dont mention containers
